...
function SpecialtyModal({
  ...
  const handleTemporarySpecialtyToggle = (specialty: string) => {
  ...
  const handleRollbackTemporaryApply = () => {
    ...
    >
      <StyledContainer>
        ...
        <StyledSpecialtyWrapper>
          {specialties.map((specialty) => (
            <SpecialtyCheckbox
              ...
              onChange={() => handleTemporarySpecialtyToggle(specialty.title)}
            />
          ))}
        </StyledSpecialtyWrapper>
        ...
        <StyledButtonWrapper>
          ...
          <StyledPrimaryButton onClick={handleSpecialtiesApply}>
            적용
          </StyledPrimaryButton>
        </StyledButtonWrapper>
      </StyledContainer>
