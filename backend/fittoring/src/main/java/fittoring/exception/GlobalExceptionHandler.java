...
import fittoring.application.business.exception.CategoryNotFoundException;
import fittoring.application.business.exception.CertificateNotFoundException;
...
import fittoring.application.business.exception.ForbiddenException;
import fittoring.application.business.exception.InvalidCertificateException;
import fittoring.application.business.exception.InvalidCursorException;
import fittoring.application.business.exception.InvalidPhoneVerificationException;
...
import fittoring.application.business.exception.MemberNotFoundException;
import fittoring.application.business.exception.MentorAndMenteeIsSameException;
import fittoring.application.business.exception.MentoringAlreadyExistException;
import fittoring.application.business.exception.MentoringNotFoundException;
import fittoring.application.business.exception.MisMatchPasswordException;
import fittoring.application.business.exception.NotFoundMemberException;
import fittoring.application.business.exception.NotFoundStatusException;
import fittoring.application.business.exception.PasswordEncryptionException;
import fittoring.application.business.exception.ReservationNotCompletedException;
import fittoring.application.business.exception.ReservationNotFoundException;
import fittoring.application.business.exception.ReviewAlreadyExistsException;
import fittoring.application.business.exception.ReviewNotFoundException;
